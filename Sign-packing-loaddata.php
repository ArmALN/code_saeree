...
<div class="content-wrapper">
    ...
    $data['data_breadcrumb'] = array(
        "Link" => 'SignV2',
        "Name" => 'ป้ายสินค้า',
        "Action" => 'แผนกบรรจุภัณฑ์ ดึงข้อมูลก่อนทำ'
    );
    ...
    <section class="content">
        <div class="card card-primary">
            <div class="card-header">
                <h2 class="card-title">แผนกบรรจุภัณฑ์ : ดึงข้อมูลก่อนทำป้าย</h2>
        ...
        <div class="row">
            <div class="col-md-12" >
                <a href="<?php echo site_url('SignV2/packing');?>"><button type="button" class="btn btn-block bg-green btn-lg">ทำป้าย</button></a>
            </div>
        </div>
    </section>
</div>
