...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-3" >
            <a href="<?php echo site_url('SignV2/packing_loaddata');?>"><button type="button" class="btn btn-block btn-primary">ไปหน้าดึงข้อมูล</button></a>
        </div>
    </div>
    <br>
    <div class="card "> 
        <div class="card-header bg-indigo">
            ...
            <h2 class="card-title">แผนกบรรจุภัณฑ์ : รายการรอทำป้าย</h2>
        </div>
        <div class="card-body">
            <div  class="row">
                <div class="col-md-4">
    ...
    <div class="card "> 
        <div class="card-header bg-indigo">
            <h2 class="card-title">แผนกบรรจุภัณฑ์ : รายการสถานะป้าย</h2>
        </div>
        <div class="card-body">
            <div  class="row">
                <div class="col-md-4">
